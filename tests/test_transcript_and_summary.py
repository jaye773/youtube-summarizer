...
from app import get_transcript, generate_summary, get_video_details, get_videos_from_playlist
            ...
            'items': [
                {
                    ...
                    'snippet': {
                        'title': 'Video 1 Title',
                        'thumbnails': {
                            'medium': {'url': 'http://example.com/thumb1.jpg'}
                        }
                    }
                },
                {
                    ...
                    'snippet': {
                        'title': 'Video 2 Title',
                        'thumbnails': {
                            'medium': {'url': 'http://example.com/thumb2.jpg'}
                        }
                    }
                }
            ]
