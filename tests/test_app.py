...
class TestYouTubeSummarizer(unittest.TestCase):
    ...
    @patch('app.youtube')
    def test_summarize_single_video(self, mock_youtube, mock_get_video_details, mock_get_transcript, mock_generate_summary):
        ...
        response = self.client.post('/summarize',
                                   data=json.dumps({'urls': [self.test_video_url]}),
                                   content_type='application/json')
...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_get_playlist_id(self):
        ...
        self.assertEqual(get_playlist_id("https://www.youtube.com/playlist?list=PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf"), 
                        "PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf")
        
        # Test watch URL with playlist
        self.assertEqual(get_playlist_id("https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf"), 
                        "PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf")
