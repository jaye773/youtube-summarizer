...
class ErrorHandler:
    ...
    def handle_error(
        ...
        retry_eligible = policy.retry_eligible and retry_count < policy.max_retries

        # Calculate retry delay with exponential backoff
        retry_delay = 0.0
        if retry_eligible:
            retry_delay = self._calculate_retry_delay(policy, retry_count)
    ...
    def get_next_retry_time(self, error_info: ErrorInfo) -> Optional[datetime]:
        """
    ...
    def update_retry_policy(self, category: ErrorCategory, policy: RetryPolicy) -> None:
        """
